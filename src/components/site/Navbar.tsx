...
export function Navbar() {
  ...
  const initials = namePart
    ? namePart.split(/\s+/)[0].slice(0, 2).toUpperCase()
            ...
            return (
              <Link
                ...
                className={cn(
                  ...
                  active
                    ? "text-primary after:absolute after:inset-x-3 after:-bottom-px after:h-0.5 after:rounded-full after:bg-linear-to-r after:from-primary after:to-accent-purple"
